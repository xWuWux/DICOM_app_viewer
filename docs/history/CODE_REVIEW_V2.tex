% SUPERSEDED / HISTORICAL: this is a 2026-09-10 snapshot, before dozens of
% subsequent PRs (rate limiting, WAL mode, session tokens, unit tests, and
% more -- see `git log`). Kept for the record, not as current status; see
% README.md and docs/ARCHITECTURE.md for what's actually true today.
